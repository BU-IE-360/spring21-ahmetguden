...
# Introduction
Recently, Turkish economy suffers from high inflation and high unemployment rates. Therefore, in this paper, three macroeconomic indicators of Turkish economy is inspected: TL per USD exchange rate, consumer price index and unemployment rate. The relationship between actual data and the search volume of the indicators are analyzed.
